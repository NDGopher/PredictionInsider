...
Used by auto-promote and adaptive lab. Unique closed+open books are truth —
not Polydata month curves.
"""
...
def load_analysis(wallet: str, username: str) -> dict[str, Any] | None:
    ...
    if not json_p.exists():
        # try OUTPUT_DIR glob by wallet prefix
...
def detect_regime(analysis: dict[str, Any] | None) -> dict[str, Any]:
    ...
    # Count trailing green months and prior red streak
    green_streak = 0
    ...
    if l30_n < 8:
        ...
        # Poster case: SDTrading — months of red then a strong green month / hot 30d
        regime = "turnaround"
