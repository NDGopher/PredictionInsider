"""
Trader CSV fetcher: Capman — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/Capman_0xc5b5bb.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xc5b5bbd42624a8f0c8dfa90221913007d8c77e80"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "Capman_0xc5b5bb.csv"
