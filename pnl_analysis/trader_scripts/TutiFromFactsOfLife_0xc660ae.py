"""
Trader CSV fetcher: TutiFromFactsOfLife — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/TutiFromFactsOfLife_0xc660ae.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "TutiFromFactsOfLife_0xc660ae.csv"
