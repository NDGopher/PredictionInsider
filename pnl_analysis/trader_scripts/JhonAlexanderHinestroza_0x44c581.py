"""
Trader CSV fetcher: JhonAlexanderHinestroza — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/JhonAlexanderHinestroza_0x44c581.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "JhonAlexanderHinestroza_0x44c581.csv"
