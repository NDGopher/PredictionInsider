"""
Trader CSV fetcher: 0xD9E0AACa471f48F91A26E8669A805f2 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/0xD9E0AACa471f48F91A26E8669A805f2_0xd9e0aa.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xd9e0aaca471f489be338fd0f91a26e8669a805f2"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "0xD9E0AACa471f48F91A26E8669A805f2_0xd9e0aa.csv"
