"""
Trader CSV fetcher: norrisfan — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/norrisfan_0xe72bb5.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "norrisfan_0xe72bb5.csv"
