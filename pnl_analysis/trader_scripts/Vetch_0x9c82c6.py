"""
Trader CSV fetcher: Vetch — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/Vetch_0x9c82c6.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x9c82c60829df081d593055ee5fa288870c051f13"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "Vetch_0x9c82c6.csv"
