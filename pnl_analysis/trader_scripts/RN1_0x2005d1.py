"""
Trader CSV fetcher: RN1 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/RN1_0x2005d1.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "RN1_0x2005d1.csv"
