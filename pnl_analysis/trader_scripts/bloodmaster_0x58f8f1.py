"""
Trader CSV fetcher: bloodmaster — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/bloodmaster_0x58f8f1.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x58f8f1138be2192696378629fc9aa23c7910dc70"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "bloodmaster_0x58f8f1.csv"
