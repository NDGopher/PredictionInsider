"""
Trader CSV fetcher: S-Works — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/S-Works_0xee00ba.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "S-Works_0xee00ba.csv"
