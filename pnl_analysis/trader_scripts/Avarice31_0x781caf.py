"""
Trader CSV fetcher: Avarice31 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/Avarice31_0x781caf.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "Avarice31_0x781caf.csv"
