"""
Trader CSV fetcher: 0x53eCc53E7 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/0x53eCc53E7_0x53ecc5.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x53ecc53e7a69aad0e6dda60264cc2e363092df91"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "0x53eCc53E7_0x53ecc5.csv"
