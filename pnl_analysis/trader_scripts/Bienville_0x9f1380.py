"""
Trader CSV fetcher: Bienville — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/Bienville_0x9f1380.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x9f138019d5481fdc5c59b93b0ae4b9b817cce0fd"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "Bienville_0x9f1380.csv"
