"""
Trader CSV fetcher: TTdes — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/TTdes_0x258670.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x25867077c891354137bbaf7fde12eec6949cc893"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "TTdes_0x258670.csv"
