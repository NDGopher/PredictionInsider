"""
Trader CSV fetcher: RandomPunter — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/RandomPunter_0xf588b1.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xf588b19afe63e1aba00f125f91e3e3b0fdc62b81"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "RandomPunter_0xf588b1.csv"
