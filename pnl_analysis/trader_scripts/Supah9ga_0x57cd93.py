"""
Trader CSV fetcher: Supah9ga — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/Supah9ga_0x57cd93.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "Supah9ga_0x57cd93.csv"
