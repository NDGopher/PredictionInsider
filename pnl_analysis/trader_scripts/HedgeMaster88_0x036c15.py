"""
Trader CSV fetcher: HedgeMaster88 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/HedgeMaster88_0x036c15.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "HedgeMaster88_0x036c15.csv"
