"""
Trader CSV fetcher: UAEVALORANTFAN — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/UAEVALORANTFAN_0xc65ca4.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xc65ca4755436f82d8eb461e65781584b8cadea39"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "UAEVALORANTFAN_0xc65ca4.csv"
