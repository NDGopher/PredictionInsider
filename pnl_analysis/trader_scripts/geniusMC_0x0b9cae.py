"""
Trader CSV fetcher: geniusMC — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/geniusMC_0x0b9cae.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "geniusMC_0x0b9cae.csv"
