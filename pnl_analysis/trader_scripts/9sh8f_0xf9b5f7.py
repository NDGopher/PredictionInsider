"""
Trader CSV fetcher: 9sh8f — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/9sh8f_0xf9b5f7.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xf9b5f7293b8258be8b0e1f03717c5d2ad94809ee"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "9sh8f_0xf9b5f7.csv"
