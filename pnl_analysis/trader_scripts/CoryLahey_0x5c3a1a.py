"""
Trader CSV fetcher: CoryLahey — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/CoryLahey_0x5c3a1a.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "CoryLahey_0x5c3a1a.csv"
