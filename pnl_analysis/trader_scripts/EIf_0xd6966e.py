"""
Trader CSV fetcher: EIf — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/EIf_0xd6966e.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xd6966eb1ae7b52320ba7ab1016680198c9e08a49"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "EIf_0xd6966e.csv"
