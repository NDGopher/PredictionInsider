"""
Trader CSV fetcher: BoomLaLa — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/BoomLaLa_0xe40172.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "BoomLaLa_0xe40172.csv"
