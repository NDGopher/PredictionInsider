"""
Trader CSV fetcher: bigmoneyloser00 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/bigmoneyloser00_0xdbb9b3.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xdbb9b3616f733e19278d1ca6f3207a8344b5ed8d"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "bigmoneyloser00_0xdbb9b3.csv"
