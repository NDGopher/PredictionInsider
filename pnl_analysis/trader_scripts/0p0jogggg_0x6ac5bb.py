"""
Trader CSV fetcher: 0p0jogggg — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/0p0jogggg_0x6ac5bb.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "0p0jogggg_0x6ac5bb.csv"
