"""
Trader CSV fetcher: TheMangler — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/TheMangler_0x970367.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x9703676286b93c2eca71ca96e8757104519a69c2"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "TheMangler_0x970367.csv"
