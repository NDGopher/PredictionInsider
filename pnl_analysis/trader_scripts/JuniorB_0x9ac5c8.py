"""
Trader CSV fetcher: JuniorB — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/JuniorB_0x9ac5c8.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x9ac5c8496bc84f642bac181499bf64405a5c6a3d"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "JuniorB_0x9ac5c8.csv"
