"""
Trader CSV fetcher: tcp2 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/tcp2_0x6b7c75.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "tcp2_0x6b7c75.csv"
