"""
Trader CSV fetcher: ckw — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/ckw_0x92672c.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "ckw_0x92672c.csv"
