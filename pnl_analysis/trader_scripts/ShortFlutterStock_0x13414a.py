"""
Trader CSV fetcher: ShortFlutterStock — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/ShortFlutterStock_0x13414a.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x13414a77a4be48988851c73dfd824d0168e70853"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "ShortFlutterStock_0x13414a.csv"
