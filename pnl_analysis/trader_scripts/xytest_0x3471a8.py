"""
Trader CSV fetcher: xytest — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/xytest_0x3471a8.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x3471a897e56a8d3621ca79af87dae4325977f17e"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "xytest_0x3471a8.csv"
