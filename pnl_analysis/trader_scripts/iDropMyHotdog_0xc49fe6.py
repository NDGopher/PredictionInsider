"""
Trader CSV fetcher: iDropMyHotdog — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/iDropMyHotdog_0xc49fe6.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0xc49fe658479db29e1a2fefebf0735f657dca9e05"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "iDropMyHotdog_0xc49fe6.csv"
