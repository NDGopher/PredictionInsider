"""
Trader CSV fetcher: CemeterySun — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/CemeterySun_0x37c187.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "CemeterySun_0x37c187.csv"
