"""
Trader CSV fetcher: fkgggg2 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/fkgggg2_0x52ecea.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x52ecea7b3159f09db589e4f4ee64872fd0bba6f3"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "fkgggg2_0x52ecea.csv"
