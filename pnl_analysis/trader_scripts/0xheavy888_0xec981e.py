"""
Trader CSV fetcher: 0xheavy888 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/0xheavy888_0xec981e.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "0xheavy888_0xec981e.csv"
