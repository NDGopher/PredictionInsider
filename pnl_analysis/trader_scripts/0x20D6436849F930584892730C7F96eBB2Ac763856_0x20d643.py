"""
Trader CSV fetcher: 0x20D6436849F930584892730C7F96eBB2Ac763856 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/0x20D6436849F930584892730C7F96eBB2Ac763856_0x20d643.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x20d6436849f930584892730c7f96ebb2ac763856"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "0x20D6436849F930584892730C7F96eBB2Ac763856_0x20d643.csv"
