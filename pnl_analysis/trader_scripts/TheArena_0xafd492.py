"""
Trader CSV fetcher: TheArena — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/TheArena_0xafd492.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "TheArena_0xafd492.csv"
