"""
Trader CSV fetcher: Cannae — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/Cannae_0x7ea571.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "Cannae_0x7ea571.csv"
