"""
Trader CSV fetcher: kch123 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/kch123_0x6a72f6.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "kch123_0x6a72f6.csv"
