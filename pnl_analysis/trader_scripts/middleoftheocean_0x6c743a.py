"""
Trader CSV fetcher: middleoftheocean — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/middleoftheocean_0x6c743a.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "middleoftheocean_0x6c743a.csv"
