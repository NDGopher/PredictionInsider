"""
Trader CSV fetcher: Andromeda1 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/Andromeda1_0x39932c.py
"""
import requests
import pandas as pd
import time
...
ADDRESS = "0x39932ca2b7a1b8ab6cbf0b8f7419261b950ccded"
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output"
OUTPUT_DIR.mkdir(exist_ok=True)
FINAL_CSV = OUTPUT_DIR / "Andromeda1_0x39932c.csv"
