"""
Trader CSV fetcher: DLEK — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/DLEK_0x6e82b9.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "DLEK_0x6e82b9.csv"
