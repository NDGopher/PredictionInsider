"""
Trader CSV fetcher: 877s8d8g89I9f8d98fd99ww2 — same logic as polyhistory/Cannae.py.
Writes to pnl_analysis/output so pipeline and ingest stay in sync.
Run from repo root: python pnl_analysis/trader_scripts/877s8d8g89I9f8d98fd99ww2_0x1b5e20.py
"""
import requests
import pandas as pd
import time
...
FINAL_CSV = OUTPUT_DIR / "877s8d8g89I9f8d98fd99ww2_0x1b5e20.csv"
