...
NAMED: list[tuple[str, str, str]] = [
    ...
    ("0x2f44fa076c8d2976ac6bea0ddfd9502bad2b93c2", "TennisLove", "pd_month_sports_15"),
    ("0x3eb095d871501a1d7a3cb086a22d174b52356a68", "predictionlegend", "pd_month_sports_14"),
    ("0x983eedfbd75803602e4a6e6ea9aab6dc6b9c6748", "3edmond.dantes", "pd_month_sports_12"),
